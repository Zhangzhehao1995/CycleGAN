...
channel_size                 = 3
#classes                      = 10
target_size_train            = (160, 160)
target_size_test             = (160, 160)
...
generator_iterations         = 4               # Number of generator training iterations in each training loop
...
#zzh
save_interval                      = 5     # Images saving interval for epoch
shuffle_buffer                     = batch_size_train*50
