...
image_path_subdirs_train     = ('trainA', 'trainB')        # subdirectories for real_image_A and real_image_B for train
image_path_subdirs_test      = ('testA', 'testB')       # subdirectories for real_image_A and real_image_B for test
...
target_size_test              = (256, 256)
#target_size_valid            = (160, 160)
...
decay_epoch                  = 100  # The epoch where the linear decay of the learning rates start
...
da_depth_shift_range               = 0.0    # Rnd vertical shift
...
#zzh
save_interval                      = 10     # Images saving interval for epoch
load_size_train                    = (286, 286)
load_size_test                     = (256, 256)
load_epoch_for_test                = 200